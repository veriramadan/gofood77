        		...
        		if($pilihan == "y" || $pilihan == "Y")
			{
				...
				else
				{
					...
					else
					{
        					...
        					sleep(1);}
        					sleep(3);
        					$gojek = request('/go-promotions/v1/promotions/enrollments', $token, '{"promo_code":"WADAWGOJEK"}');
        					$messagegojek = fetch_value($gojek,'"message":"','"');
        					if(strpos($gojek, 'Promo kamu sudah bisa dipakai.'))
						{
       		 					echo "\n".color("green","Message : ".$messagegojek);
        						goto goride;
        					}
						else
						{
